  ...
  error="sem")
{
  ...
  positions <- data.frame(
    id = rep(ids, each = 4),
    x = c(c(-1.5, -1.5, 1.5, 1.5), c(-1.5, -1.5, 1.5, 1.5), c(1.5, 1.5, 10, 10), c(10, 10, 1.5, 1.5))/3,
    y = c(c(-10, 0, 0, -10), c(0, 10, 10, 0), c(-10, 0, 0, -10), c(0, 10, 10, 0)),
    alpha=c(rep(.15, 8), rep(.08, 8))
  )
...
(p1 <- make_delta_plot(sntall, grps=c("FIB","Time", "Recipe", "Temp", "OL"), times=c(0, 3, 6, 9), OLs=c(.5, 2, 3.5), shapes=T, size=T, error="sem"))
